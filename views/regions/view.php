...
<section id="section-search">
    ...
    <div class="wrapper menu-header">
        <h1>
          <strong>
            <?=$region->region_name?>
            <a href="/regions">Изменить регион</a>
          </strong>
        </h1>
    </div>
    ...
    <section class="page-products">
      <div class="wrapper">
        <h2 class="title-section">Товары мебельных организаций в регионе "<?=$region->region_name?>"(<?=$pagination_products->totalCount?>)</h2>
    ...
    <div class="page-organizations">
      <h2 class="title-section">Мебельные организации в регионе "<?=$region->region_name?>"(<?=$pagination_manufacturers->totalCount?>)</h2>
      <div class="factories">
