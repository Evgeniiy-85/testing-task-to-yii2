  ...
  <div class="wrapper">
    ...
    <div class="search-form">
      <form id="form-search" action="/search" method="GET">
          ...
          <input type="text" class="form-control" name="q" value="" placeholder="Введите название организации или товара">
...
<section class="page-products">
  <div class="wrapper">
    <h2 class="title-section">Товары мебельных организаций</h2>
...
<div class="page-organizations">
  <h2 class="title-section">Мебельные организации</h2>
  <div class="factories">
